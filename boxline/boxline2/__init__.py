...
def squaregram(ori):
    ...
    draw.rectangle((int(sz / 2) - int(deg1 / 3) - int(deg1*0.6), int(sz / 2) + int(deg1 / 6),
                    int(sz / 2) + int(deg1 / 3) - int(deg1*0.6), int(sz / 2) - int(deg1 / 6)),
...
def testgram(ori):
    ...
    draw.rectangle((int(sz / 2) - int(deg1 / 6), int(sz / 2) + int(f / 2),
                    int(sz / 2) + int(deg1 / 6), int(sz / 2) - int(f / 2)),
