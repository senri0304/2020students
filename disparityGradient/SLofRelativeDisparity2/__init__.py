...
for k in relative_disparity:
    ...
    draw.rectangle((int(sz / 2) - int(ll / 2) - disparity / 2, int(sz / 2) + int(f / 2),
                   ...
                   fill=(int(lb*2), 0, 0), outline=None)
    draw2.rectangle((int(sz / 2) - int(ll / 2) + disparity / 2, int(sz / 2) + int(f / 2),
                     int(sz / 2) + int(ll / 2) + disparity / 2, int(sz / 2) - int(f / 2)),
                    fill=(153, 0, 0), outline=None)

    draw.rectangle((int(sz / 2) - int(ll / 2) - f*k / 2, int(sz / 2) + int(f / 2) + distractor_y,
                    int(sz / 2) + int(ll / 2) - f*k / 2, int(sz / 2) - int(f / 2) + distractor_y),
                   fill=(0, 0, 0), outline=None)
    draw2.rectangle((int(sz / 2) - int(ll / 2) + f*k / 2, int(sz / 2) + int(f / 2) + distractor_y,
                     int(sz / 2) + int(ll / 2) + f*k / 2, int(sz / 2) - int(f / 2) + distractor_y),
                    fill=(0, 0, 0), outline=None)
    ...
    # Write images
    basenameR = os.path.basename(str(k) + 'lsR.png')
    basenameL = os.path.basename(str(k) + 'lsL.png')
