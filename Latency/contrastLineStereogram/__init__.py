...
# fixation point
def fixation(drawing):
    drawing.rectangle((int(sz / 2) + eccentricity - f, int(sz / 2) + eccentricity + f * 3,
                       int(sz / 2) + eccentricity + f, int(sz / 2) + eccentricity - f * 3),
                      fill=(0, 0, 255), outline=None)
    drawing.rectangle((int(sz / 2) + eccentricity - f * 3, int(sz / 2) + eccentricity + f,
